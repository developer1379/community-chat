    ...
    <header class="w-full bg-slate-900 border-b border-slate-850 py-3.5 px-4 sm:px-6 lg:px-8 shadow-md flex-shrink-0 text-white">
        <div class="max-w-7xl mx-auto flex items-center justify-between gap-4">
            ...
            <div class="flex items-center gap-3">
                ...
                <a href="{{ route('admin.categories.index') }}" class="flex items-center gap-1 px-3 py-1.5 rounded-lg text-slate-300 hover:text-white hover:bg-slate-800 transition-all font-bold text-xs cursor-pointer">
